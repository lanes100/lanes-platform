...
// === Policy Platform Website ===
// Single-file React app you can preview here or drop into any Vite/Next project.
// Uses Tailwind classes (no import needed in this canvas). No external deps.
// Features: sticky Table of Contents, mobile drawer, section deep-links, search/highlight,
// dark mode toggle (saved to localStorage), copy-link, print/export, minimal analytics hook.

export default function PolicyPlatformSite() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 py-8 text-center text-sm text-zinc-500">
        Built with ❤️ — single-file React. Use the Export buttons above to save/share.
      </footer>
    </div>
  );
}
